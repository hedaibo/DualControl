...
class ThreadPoolManager {
    private val TAG = "ThreadPoolManager"
    /**
     * 单例设计模式（饿汉式）
    ...
    private  var corePoolSize: Int = 5//核心线程池的数量，同时能够执行的线程数量
    private var maximumPoolSize: Int = 8//最大线程池数量，表示当缓冲队列满的时候能继续容纳的等待任务的数量
    private val keepAliveTime: Long = 1//存活时间
